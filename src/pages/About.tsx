      ...
      <div className="mt-12 space-y-8 text-left">
        <section className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            BCards is designed to revolutionize how professionals manage and
            share their business contacts. We provide a modern, digital solution
            for organizing business cards, making networking more efficient and
        ...
        <section className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            Simply create an account, design your digital business card, and
            start networking! Business users can create and manage multiple
            cards, while regular users can collect and organize cards from their
            professional network. Our platform makes it easy to stay connected
        ...
        <section className="rounded-lg bg-white p-6 shadow-lg dark:bg-gray-800">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
            ...
            to our support team, and we'll be happy to assist you with any
            inquiries about our digital business card platform.
          </p>
        </section>
      </div>
    </div>
